// ═══════════════════════════════════════════
//  BlackJack Royale — Service Worker v2
//  Estrategia: Cache-first para assets estáticos
//              Network-first para Firebase (tiempo real)
// ═══════════════════════════════════════════

const CACHE_NAME = 'bj-royale-v2';
...
self.addEventListener('fetch', event => {
  ...
  event.respondWith(
    caches.match(event.request).then(cached => {
      ...
      // Si hay cache, úsala inmediatamente y actualiza en segundo plano
...
console.log('[SW] BlackJack Royale Service Worker v2 activo');

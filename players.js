...
window.AB_SECTIONS_V2 = [
  ...
  {id:'mli',name:'Mali',flag:'ml',base:1442},
  {id:'alg',name:'Argelia',flag:'dz',base:1455},
  {id:'tnz',name:'Tanzania',flag:'tz',base:1468},
  ...
  {id:'jor',name:'Jordania',flag:'jo',base:1546},
  {id:'uzb',name:'Uzbekistan',flag:'uz',base:1572},
  {id:'bol',name:'Bolivia',flag:'bo',base:1585},
  {id:'ven',name:'Venezuela',flag:'ve',base:1598},
  {id:'nze',name:'Nueva Zelanda',flag:'nz',base:1611},
  {id:'jam',name:'Jamaica',flag:'jm',base:1624},
];

// offset, nombre, posicion, rating, wiki_title
window.AB_PLAYERS_V2 = {
  col:[
    [2,'Camilo Vargas','POR',78,'Camilo Vargas (footballer)'],
    ...
    [9,'James Rodriguez','MED',85,'James Rodriguez'],
  ...
  mli:[
    [2,'Djigui Diarra','POR',76,'Djigui Diarra'],
    [3,'Hamari Traore','LAT',78,'Hamari Traore'],
    [4,'Molla Wague','DEF',77,'Molla Wague'],
    [5,'Falaye Sacko','DEF',75,'Falaye Sacko'],
    [6,'Yves Bissouma','MED',82,'Yves Bissouma'],
    [7,'Amadou Haidara','MED',80,'Amadou Haidara'],
    [8,'Diadie Samassekou','MED',78,'Diadie Samassekou'],
    [9,'Adama Traore','DEL',81,'Adama Traore (footballer, born 1996)'],
    [10,'Moussa Marega','DEL',78,'Moussa Marega'],
    [11,'Ibrahima Kone','DEL',77,'Ibrahima Kone'],
    [12,'Lassine Sinayoko','DEL',76,'Lassine Sinayoko'],
  ],
  alg:[
  ...
  tnz:[
    [2,'Metacha Mnata','POR',68,'Metacha Mnata'],
    [3,'Jonas Mkude','DEF',69,'Jonas Mkude'],
    [4,'Erasto Nyoni','DEF',68,'Erasto Nyoni'],
    [5,'Shomari Kapombe','LAT',68,'Shomari Kapombe'],
    [6,'Thomas Ulimwengu','MED',69,'Thomas Ulimwengu'],
    [7,'Himid Mao','MED',68,'Himid Mao'],
    [8,'Bernard Morrison','MED',70,'Bernard Morrison'],
    [9,'Mbwana Samatta','DEL',74,'Mbwana Samatta'],
    [10,'Simon Msuva','DEL',70,'Simon Msuva'],
    [11,'Novatus Dismas','DEL',68,'Novatus Dismas'],
    [12,'Kelvin Yondani','LAT',67,'Kelvin Yondani'],
  ],
  jap:[
  ...
  jor:[
    [2,'Yazeed Abulaila','POR',73,'Yazeed Abulaila'],
    [3,'Baher Al-Saqer','DEF',72,'Baher Al-Saqer'],
    [4,'Mohammad Abu Zema','DEF',72,'Mohammad Abu Zema'],
    [5,'Musa Al-Tamari','DEL',76,'Musa Al-Tamari'],
    [6,'Yaseen Al-Bakhit','MED',73,'Yaseen Al-Bakhit'],
    [7,'Oday Dabbagh','DEL',74,'Oday Dabbagh'],
    [8,'Ahmad Nuqul','DEL',73,'Ahmad Nuqul'],
    [9,'Mousa Suleiman','MED',72,'Mousa Suleiman'],
    [10,'Omar Al-Dmeiri','DEF',71,'Omar Al-Dmeiri'],
    [11,'Mahmoud Al-Mardi','DEL',72,'Mahmoud Al-Mardi'],
    [12,'Baha Faisal','MED',72,'Baha Faisal'],
  ],
  uzb:[
    [2,'Eldorbek Suyunov','POR',73,'Eldorbek Suyunov'],
    [3,'Sanjar Tursunov','DEF',72,'Sanjar Tursunov'],
    [4,'Bahodir Suyunov','DEF',73,'Bahodir Suyunov'],
    [5,'Khusan Murzaev','LAT',72,'Khusan Murzaev'],
    [6,'Islom Tukhtahujaev','MED',73,'Islom Tukhtahujaev'],
    [7,'Otabek Shukurov','MED',74,'Otabek Shukurov'],
    [8,'Oybek Bozorov','MED',72,'Oybek Bozorov'],
    [9,'Eldor Shomurodov','DEL',79,'Eldor Shomurodov'],
    [10,'Dostonbek Khamdamov','DEL',75,'Dostonbek Khamdamov'],
    [11,'Bobur Abdixoliqov','DEL',73,'Bobur Abdixoliqov'],
    [12,'Jamshid Iskanderov','MED',72,'Jamshid Iskanderov'],
  ],
  bol:[
    [2,'Carlos Lampe','POR',75,'Carlos Lampe'],
    [3,'Diego Bejarano','DEF',73,'Diego Bejarano'],
    [4,'Jose Sagredo','DEF',73,'Jose Sagredo'],
    [5,'Marc Enoumba','LAT',72,'Marc Enoumba'],
    [6,'Santiago Rodriguez','MED',74,'Santiago Rodriguez (footballer)'],
    [7,'Heber Arce','MED',72,'Heber Arce'],
    [8,'Ramiro Vaca','MED',73,'Ramiro Vaca'],
    [9,'Marcelo Moreno Martins','DEL',76,'Marcelo Moreno Martins'],
    [10,'Rodrigo Ramallo','DEL',73,'Rodrigo Ramallo'],
    [11,'Bruno Miranda','DEL',72,'Bruno Miranda (footballer)'],
    [12,'Erwin Saavedra','DEL',71,'Erwin Saavedra'],
  ],
  ven:[
    [2,'Wuilker Farinhez','POR',79,'Wuilker Farinhez'],
    [3,'Nahuel Ferraresi','DEF',79,'Nahuel Ferraresi'],
    [4,'Yordan Osorio','DEF',78,'Yordan Osorio'],
    [5,'Alexander Gonzalez','LAT',77,'Alexander Gonzalez (footballer, born 1991)'],
    [6,'Mikel Villanueva','LAT',76,'Mikel Villanueva'],
    [7,'Tomas Rincon','MED',79,'Tomas Rincon'],
    [8,'Jefferson Savarino','MED',79,'Jefferson Savarino'],
    [9,'Yangel Herrera','MED',82,'Yangel Herrera'],
    [10,'Darwin Machis','DEL',78,'Darwin Machis'],
    [11,'Salomon Rondon','DEL',79,'Salomon Rondon'],
    [12,'Eduard Bello','DEL',77,'Eduard Bello'],
  ],
  nze:[
    [2,'Stefan Marinovic','POR',75,'Stefan Marinovic'],
    [3,'Winston Reid','DEF',76,'Winston Reid'],
    [4,'Tommy Smith','DEF',75,'Tommy Smith (New Zealand footballer)'],
    [5,'Michael Boxall','DEF',74,'Michael Boxall'],
    [6,'Liberato Cacace','LAT',76,'Liberato Cacace'],
    [7,'Ryan Thomas','MED',74,'Ryan Thomas (footballer, born 1993)'],
    [8,'Elijah Just','MED',74,'Elijah Just'],
    [9,'Clayton Lewis','MED',75,'Clayton Lewis (footballer)'],
    [10,'Chris Wood','DEL',80,'Chris Wood (New Zealand footballer)'],
    [11,'Matthew Garbett','MED',73,'Matthew Garbett'],
    [12,'Dane Ingham','DEF',73,'Dane Ingham'],
  ],
  jam:[
    [2,'Andre Blake','POR',78,'Andre Blake'],
    [3,'Damion Lowe','DEF',75,'Damion Lowe'],
    [4,'Oniel Fisher','LAT',75,'Oniel Fisher'],
    [5,'Kemar Lawrence','LAT',77,'Kemar Lawrence'],
    [6,'Je-Vaughn Watson','MED',74,'Je-Vaughn Watson'],
    [7,'Demarai Gray','MED',79,'Demarai Gray'],
    [8,'Junior Flemmings','MED',75,'Junior Flemmings'],
    [9,'Bobby Reid','DEL',77,'Bobby Reid'],
    [10,'Michail Antonio','DEL',79,'Michail Antonio'],
    [11,'Leon Bailey','DEL',81,'Leon Bailey'],
    [12,'Shamar Nicholson','DEL',76,'Shamar Nicholson'],
  ],
};
